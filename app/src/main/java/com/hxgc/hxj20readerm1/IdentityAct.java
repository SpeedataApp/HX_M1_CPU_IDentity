...
import com.identityUtil.MyAnimation;
import com.identityUtil.PlaySoundUtils;
...
public class IdentityAct extends AppCompatActivity {
        ...
        btnGet.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b) {
                    ...
                    MyAnimation.showLogoAnimation(IdentityAct.this, imageView);
                } else {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final boolean result = iid2Service.initDev(IdentityAct.this, new
                            IDReadCallBack() {
                                @Override
                            ...
                            },"/dev/ttyMT1",115200, DeviceControl.PowerType.MAIN,new int[]{94});
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (!result) {
                                new AlertDialog.Builder(IdentityAct.this).setCancelable(false)
